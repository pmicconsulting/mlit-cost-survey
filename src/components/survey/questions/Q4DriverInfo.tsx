                ...
                <td key={cat.id} className="border border-slate-300 px-2 py-2 text-center">
                  <div className="flex items-center justify-center gap-1">
                    <input
                      ...
                      className={`w-16 px-2 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-right text-sm ${data.driverCount[cat.id] ? 'input-filled' : 'flash-green'}`}
                      placeholder="0"
                    />
                  ...
                  >
                    <div className="flex items-center justify-center gap-1">
                      <input
                        ...
                        className={`w-16 px-2 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-right text-sm ${data.drivers[cat.id][metric.id as keyof DriverMetrics] ? 'input-filled' : 'flash-green'}`}
                        placeholder="-"
                      />
