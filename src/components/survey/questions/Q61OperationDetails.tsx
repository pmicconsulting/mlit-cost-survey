...
import { useQ61 } from "../SurveyContext";
...
export function Q61OperationDetails() {
  ...
  const inputClass = (value: string | undefined) =>
    `px-3 py-2 border border-gray-300 rounded-lg text-right focus:ring-2 focus:ring-purple-500 focus:border-transparent ${value ? 'input-filled' : 'flash-green'}`;

  const tableInputClass = (value: string | undefined) =>
    `w-full px-2 py-1 border border-gray-300 rounded text-right focus:ring-2 focus:ring-purple-500 focus:border-transparent ${value ? 'input-filled' : 'flash-green'}`;

  return (
    <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
      <div className="bg-purple-600 text-white px-4 py-3">
        <h3 className="font-bold text-lg">問61 運行詳細</h3>
        ...
        <table className="w-full border-collapse border border-gray-300 text-sm">
          ...
          <tbody>
            ...
            <tr className="bg-blue-50">
              <td colSpan={4} className="border border-gray-300 px-3 py-2 font-bold text-blue-800">
                ▼ 運転者が出社
              </td>
            </tr>
            <tr>
              ...
              <td className="border border-gray-300 px-3 py-2">
                <input
                  ...
                  placeholder="例：食品"
                  className={`w-full px-2 py-1 border border-gray-300 rounded focus:ring-2 focus:ring-purple-500 focus:border-transparent ${data.cargoItem ? 'input-filled' : 'flash-green'}`}
                />
              </td>
            </tr>
            <tr>
              ...
              <td className="border border-gray-300 px-3 py-2">
                <div className="flex items-center gap-1">
                  <input
                    ...
                    className={`w-14 px-2 py-1 border border-gray-300 rounded text-right focus:ring-2 focus:ring-purple-500 focus:border-transparent ${data.transitTimeHours ? 'input-filled' : 'flash-green'}`}
                  />
                  ...
                  <input
                    ...
                    className={`w-14 px-2 py-1 border border-gray-300 rounded text-right focus:ring-2 focus:ring-purple-500 focus:border-transparent ${data.transitTimeMinutes ? 'input-filled' : 'flash-green'}`}
                  />
