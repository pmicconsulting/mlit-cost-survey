      ...
      <div className="p-4">
        <div className="flex items-center gap-2">
          <input
            ...
            placeholder=""
            className={`w-24 px-3 py-2 border border-gray-300 rounded-lg text-right focus:ring-2 focus:ring-orange-500 focus:border-transparent ${data.averageCrewCount ? 'input-filled' : 'flash-green'}`}
          />
