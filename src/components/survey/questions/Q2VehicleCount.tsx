    ...
    <div className={`bg-white rounded-xl shadow-sm border border-slate-200 p-6 ${className}`}>
      ...
      <div className="flex items-center gap-3">
        ...
        <input
          ...
          className={`w-32 px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-right ${data.totalVehicles ? 'input-filled' : 'flash-green'}`}
          placeholder="0"
        />
