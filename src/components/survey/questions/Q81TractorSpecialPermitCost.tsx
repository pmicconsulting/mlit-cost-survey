        ...
        <div>
          ...
          <div className="flex items-center gap-2">
            <input
              ...
              placeholder=""
              className={`w-40 px-3 py-2 border border-gray-300 rounded-lg text-right focus:ring-2 focus:ring-orange-500 focus:border-transparent ${data.specialPermitCost ? 'input-filled' : 'flash-pink'}`}
            />
