          ...
          <div>
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                placeholder=""
                className={`flex-1 px-3 py-2 border border-gray-300 rounded-lg text-right focus:ring-2 focus:ring-purple-500 focus:border-transparent ${data.environmentTax ? 'input-filled' : 'flash-pink'}`}
              />
          ...
          <div>
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                placeholder=""
                className={`flex-1 px-3 py-2 border border-gray-300 rounded-lg text-right focus:ring-2 focus:ring-purple-500 focus:border-transparent ${data.vehicleTax ? 'input-filled' : 'flash-pink'}`}
              />
              <span className="text-gray-600 w-12">円</span>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                placeholder=""
                className={`flex-1 px-3 py-2 border border-gray-300 rounded-lg text-right focus:ring-2 focus:ring-purple-500 focus:border-transparent ${data.weightTax ? 'input-filled' : 'flash-pink'}`}
              />
              <span className="text-gray-600 w-12">円</span>
            </div>
          </div>
