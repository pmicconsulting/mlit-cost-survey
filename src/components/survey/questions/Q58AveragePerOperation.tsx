          ...
          <div>
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                placeholder=""
                className={`flex-1 px-3 py-2 border border-gray-300 rounded-lg text-right focus:ring-2 focus:ring-purple-500 focus:border-transparent ${data.averageTransportDistance ? 'input-filled' : 'flash-pink'}`}
              />
          ...
          <div>
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                placeholder=""
                className={`flex-1 px-3 py-2 border border-gray-300 rounded-lg text-right focus:ring-2 focus:ring-purple-500 focus:border-transparent ${data.averageRoundCount ? 'input-filled' : 'flash-pink'}`}
              />
